...
На първия ред са ви дадени броя на примерите Т, които трябва да дешифрирате. На следващите Т реда имате по един пример състощ се от кодирано съобщение и ключа, с който е било кодирано. Те са описани чрез две поредици от 24 и 18 шестнадесетични цифри, разделени с един или повече интервала.

## Constraints

- 1<=T<=1000
- Може да смятате, че дешифрираните ASCII кодове са винаги печатаеми символи (ASCII кодове от 0x21 до 0x7e)
